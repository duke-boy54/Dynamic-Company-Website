                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li>
                        <a href="#">
                          <i class="mdi mdi-account-plus"></i> New Message From Client
                      ...
                      <li>
                        <a href="#">
                          <i class="mdi mdi-account-supervisor"></i> New Brand is In Deal
                          <span class=" font-size-12 d-inline-block float-right"><i class="mdi mdi-clock-outline"></i> 10 AM</span>
                        </a>
                      </li>
                      <li>
        ...
        <div class="content-wrapper">
          <div class="content">						 
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2022</span> Copyright And Designed By Sultan Allie
                <a
                  class="text-primary"
                  href="https://dukeportfolio.000webhostapp.com/#"
                  target="_blank"
                  >DUKE</a
                >.
              </p>
